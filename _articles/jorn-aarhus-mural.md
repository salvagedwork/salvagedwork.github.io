---
layout: article
title: Asger Jorn's Aarhus Mural
categories: books
description: is a limited-edition booklet documenting Asger Jorn's monumental ceramic relief at Aarhus State Gymnasium in Denmark, edited by Guy Atkins with an introduction by Erik Nyholm and photography by Dominique Darbois.
creators: [asger-jorn]
...
{% include infobox.html
    image="/assets/articles/jorn-aarhus-mural/front.jpg"
    title="Asger Jorn's Aarhus Mural"
...
**{{ page.title }}** {{page.description}} Published on the occasion of Jorn's fiftieth birthday on 3 March 1964, the booklet was sponsored by a small group of the artist's friends in England, France, Germany, and Italy with the aim of making the ceramic relief better known outside Denmark.
...
{% endcapture %}
{% include quote.html text=atkins_quote attribution="- Guy Atkins, Editor's Note" %}
...
{% endcapture %}
{% include quote.html text=nyholm_quote attribution="- Erik Nyholm, Introduction" %}
...
{% endcapture %}
{% include quote.html text=creation_quote attribution="- Erik Nyholm, Introduction" %}
...
{% capture installation_quote %}
Jorn was not risking Danish gravy on these men.
{% endcapture %}
{% include quote.html text=installation_quote attribution="- Erik Nyholm, Introduction" %}
...
{% endcapture %}
{% include quote.html text=conclusion_quote attribution="- Erik Nyholm, Introduction" %}
...
{% include thumbnail.html
    image="/assets/articles/jorn-aarhus-mural/score.jpg"
    caption="Title page of Ib Nørholm's score &quot;Relief I-II&quot;, composed in 1963."
%}
...
<iframe src="https://archive.org/embed/norholm-relief-i-ii&playlist=1&list_height=150" width="100%" height="100" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>
...
{% capture norholm_quote %}
The visual impact of the page of the score has a chance affinity with the rhythmical character of the mural.
{% endcapture %}
{% include quote.html text=norholm_quote attribution="- Erik Nyholm on Nørholm's composition" %}
...
{% include archive-embed.html id="norholm-relief" %}
...
<section data-gallery class="gallery-grid">
    <figure>
        <a href="/assets/articles/jorn-aarhus-mural/mural_01.jpg"><img src="/assets/articles/jorn-aarhus-mural/mural_01.jpg"></a>
        <figcaption>Left panel of the Aarhus mural, photographed by Dominique Darbois, 1964. 3.1m x 8.4m.</figcaption>
    </figure>
    <figure>
        <a href="/assets/articles/jorn-aarhus-mural/mural_02.jpg"><img src="/assets/articles/jorn-aarhus-mural/mural_02.jpg"></a>
        <figcaption>Central panel of the Aarhus mural, photographed by Dominique Darbois, 1964. 3.1m x 16.6m.</figcaption>
    </figure>
    <figure>
        <a href="/assets/articles/jorn-aarhus-mural/mural_03.jpg"><img src="/assets/articles/jorn-aarhus-mural/mural_03.jpg"></a>
        <figcaption>Right panel of the Aarhus mural, photographed by Dominique Darbois, 1964. 3.1m x 2.18m</figcaption>
    </figure>
</section>
