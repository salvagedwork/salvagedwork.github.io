...
{% include infobox.html
    image="/assets/articles/neue-feuerbraende/front.jpg"
    title="Neue Feuerbrände"
...
**{{ page.title }}** *(Neue Feuerbrände)* {{ page.description }}
...
{% endcapture %}
{% include quote.html text=quote_ruin attribution="- <em>Neue Feuerbrände</em>, first part, p. 38" %}
...
{% endcapture %}
{% include quote.html text=quote_register attribution="- <em>Neue Feuerbrände</em>, third part, p. 130" %}
...
{% endcapture %}
{% include quote.html text=quote_persons attribution="- <em>Neue Feuerbrände</em>, third part, p. 139" %}
...
{% endcapture %}
{% include quote.html text=quote_tendency attribution="- <em>Neue Feuerbrände</em>, third part, p. 124" %}
...
{% include book-link.html
    url="/books/neue-feuerbraende/"
    title="Neue Feuerbrände"
    description="Read the book in German and English."
    image="/assets/articles/neue-feuerbraende/front.jpg"
%}

{% include archive-embed.html id="bub_gb_FEoDAAAAYAAJ" %}

## Gallery

<section data-gallery class="gallery-grid">
    <figure>
        <a href="/assets/articles/neue-feuerbraende/front.jpg"><img src="/assets/articles/neue-feuerbraende/front.jpg"></a>
        <figcaption>Title page of the first volume, bearing the fictitious imprint of Peter Hammer at Amsterdam and Cölln, 1807.</figcaption>
    </figure>
    <figure>
        <a href="/assets/articles/neue-feuerbraende/black-register.jpg"><img src="/assets/articles/neue-feuerbraende/black-register.jpg"></a>
        <figcaption>Opening of the Black Register, second part, p. 65.</figcaption>
    </figure>
</section>

## Notes

[^1]: Julius Großmann, "Cölln, Friedrich v.," in *Allgemeine Deutsche Biographie*, vol. 4 (1876), pp. 411–412; online edition at Deutsche Biographie, accessed 15 July 2026.

[^2]: Großmann, "Cölln," ADB 4, pp. 411–412, which lists the six volumes of the *Vertraute Briefe* (Amsterdam and Cologne, 1807) and notes that the book went through several editions in a short time. The bibliography appended to the article also lists the *Intelligenzblatt zu den Neuen Feuerbränden* (1808) and the later journal *Fackeln: Journal in zwanglosen Heften* (1811). The serial run of the *Neue Feuerbrände* through 1807–1808 is recorded in the JPortal catalogue of the Thüringer Universitäts- und Landesbibliothek Jena.
