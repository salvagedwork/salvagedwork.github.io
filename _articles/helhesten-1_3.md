...
{% endcapture %}
{% include quote.html text=jacobsen_quote attribution="- Egill Jacobsen, &ldquo;Introduction to Carl-Henning Pedersen's Pictures,&rdquo; <em>Helhesten</em> 1, no. 3 (1941)" %}
...
{% endcapture %}
{% include quote.html text=lergaard_quote attribution="- Niels Lergaard, &ldquo;The Myth,&rdquo; <em>Helhesten</em> 1, no. 3 (1941)" %}
...
{% endcapture %}
{% include quote.html text=mathiesen_quote attribution="- Egon Mathiesen, &ldquo;What Modern Art Is,&rdquo; <em>Helhesten</em> 1, no. 3 (1941)" %}
