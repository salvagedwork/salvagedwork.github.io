...
{% include infobox.html
    image="/assets/articles/helhesten/helhesten_2.4_cover.jpg"
    title="Helhesten (Year 2, Booklet 4)"
    editor="Robert Dahlmann Olsen"
    issue_date="December 24, 1943"
    cover_design="Ejler Bille"
    followed_by="Helhesten (Year 2, Booklets 5 & 6)"
%}
...
{% endcapture %}
{% include quote.html text=sterup_quote attribution="- Dan Sterup-Hansen, &ldquo;Henry Heerup,&rdquo; <em>Helhesten</em> 2, no. 4 (1943)" %}
...
{% endcapture %}
{% include quote.html text=pedersen_quote attribution="- Carl-Henning Pedersen, &ldquo;Abstract Art or Fantasy Art,&rdquo; <em>Helhesten</em> 2, no. 4 (1943)" %}
...
<iframe src="https://archive.org/embed/helhesten-2-4" width="100%" height="700" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>
