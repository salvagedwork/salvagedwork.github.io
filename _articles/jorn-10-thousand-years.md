---
layout: article
title: Asger Jorn and 10,000 Years of Nordic Folk Art
categories: books
...
{% include infobox.html
    image="/assets/articles/jorn-10-thousand-years/front.jpg"
    title="Asger Jorn og 10.000 års nordisk folkekunst"
    authors="Troels Andersen &amp; Tove Nyholm (editors), Asger Jorn (texts), Gérard Franceschi (photography)"
    publisher="Silkeborg Art Museum Publishing (SISV)"
    date="1995"
    isbn="87-8793255-5"
    dimensions="Exhibition catalogue"
%}

**{{ page.title }}** *(Asger Jorn og 10.000 års nordisk folkekunst)* {{ page.description }} The catalogue documents both the realized and unrealized aspects of Jorn's project initiated through his Scandinavian Institute for Comparative Vandalism, founded in 1961, presenting texts by Jorn alongside photographs by Gérard Franceschi and contextual essays about the project's vision and legacy.
...
- [*Skånes stenskulptur under 1100-talet*](/article/skanes-stenskulptur/) (1965) - Text by Erik Cinthio, photography by Gérard Franceschi, composition by Asger Jorn. Published by Jorn's own private press as a 300-copy edition. The volume examined 12th-century stone sculpture in the Skåne region and was republished in 1995 by Borgens Forlag.
...
- [*The Bird, the Animal and the Human in Nordic Iron Age Art*](/article/fuglen-dyret-mennesket/) (2005) - Text by Bente Magnus. Published by Borgens Forlag in collaboration with Silkeborg Kunstmuseum, compiled by Tove Nyholm based on Jorn's image layouts from 1964-65
...
{% endcapture %}
{% include quote.html text=dalarna_quote attribution="- Asger Jorn, on Swedish Dalarna painting" %}
...
{% include book-link.html
    url="/books/jorn-10-thousand-years/"
    title="Asger Jorn and 10,000 Years of Nordic Folk Art"
    description="Read the exhibition catalogue in English or Danish."
    image="/assets/articles/jorn-10-thousand-years/front.jpg"
%}
...
- [*Signes gravés sur les églises de l'Eure et du Calvados*](/article/signes-graves-eure-calvados/) (1964) - Published by SISV as part of the Bibliothèque d'Alexandrie series

## Gallery

<section data-gallery class="gallery-grid">
    <figure>
        <a href="/assets/articles/jorn-10-thousand-years/10k_01.jpg"><img src="/assets/articles/jorn-10-thousand-years/10k_01.jpg"></a>
        <figcaption>Frontispiece: Asger Jorn at rock carving site near Værnes, Norway, 1965. Photo by Gérard Franceschi.</figcaption>
    </figure>
    
    <figure>
        <a href="/assets/articles/jorn-10-thousand-years/10k_02.jpg"><img src="/assets/articles/jorn-10-thousand-years/10k_02.jpg"></a>
        <figcaption>Engraved representation of a woman. Gold plate. National Museum of Denmark</figcaption>
    </figure>
    
    <figure>
        <a href="/assets/articles/jorn-10-thousand-years/10k_03.jpg"><img src="/assets/articles/jorn-10-thousand-years/10k_03.jpg"></a>
        <figcaption>Granite Head with three faces from Glejbjerg, Denmark.</figcaption>
    </figure>
</section>
