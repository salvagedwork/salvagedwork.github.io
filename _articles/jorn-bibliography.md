---
layout: article
title: A bibliography of Asger Jorn's writings to 1963
categories: books
description: is a comprehensive bibliography documenting the Danish painter and writer Asger Jorn's published writings from 1932 to 1963, compiled by Guy Atkins and Erik Schmidt.
creators: [asger-jorn]
...
{% include infobox.html
    image="/assets/articles/jorn-bibliography/front.jpg"
    title="Bibliografi over Asger Jorns skrifter til 1963 / A bibliography of Asger Jorn's writings to 1963"
...
**{{ page.title }}** *(Bibliografi over Asger Jorns skrifter til 1963)* {{page.description}} Published privately by Permild & Rosengreen in Copenhagen in 1964, this bilingual Danish-English reference work was produced as a fiftieth birthday gift for Jorn and documents 193 entries spanning his writings from his earliest youth through to the end of 1963.
...
{% endcapture %}
{% include quote.html text=intro_quote attribution="- Guy Atkins and Erik Schmidt, Introduction" %}
...
This bibliography is the first systematic attempt to catalog Jorn's writings, and a standard reference for his work as both visual artist and author. Guy Atkins would later note in the catalogue raisonné that Jorn's "activity as a writer has been so intense that, on the eve of his fiftieth birthday, there is more than enough material to justify a trial list of his published works."
...
{% include book-link.html 
       url="/books/jorn-bibliography/"
       title="Asger Jorn à Silkeborg"
       description="Read the book in English and Danish."
       image="/assets/articles/jorn-bibliography/front.jpg"
%}

{% include archive-embed.html id="jorn-bibliography" %}

## Gallery

<section data-gallery class="gallery-grid">
    <figure>
        <a href="/assets/articles/jorn-bibliography/jorn_horoscope.jpg"><img src="/assets/articles/jorn-bibliography/jorn_horoscope.jpg"></a>
        <figcaption>Astrological chart for Asger Jorn for March 3, 1914 (his date of birth).</figcaption>
    </figure>
    <figure>
        <a href="/assets/articles/jorn-bibliography/jorn_self_portrait.jpg"><img src="/assets/articles/jorn-bibliography/jorn_self_portrait.jpg"></a>
