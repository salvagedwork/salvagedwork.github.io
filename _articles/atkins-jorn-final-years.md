...
{% include infobox.html
    ...
    followed_by="Asger Jorn - Supplement - Paintings 1930-1973"
%}

**{{ page.title }}** {{page.description}} Completing the main trilogy begun almost twenty years earlier, it documents the final phase of Jorn's career, including his return to painting in 1970 and his dramatic turn to sculpture in bronze and marble in 1972.
...
{% endcapture %}
{% include quote.html text=intro_quote attribution="- Guy Atkins, Introduction to <em>The Final Years</em>" %}
...
{% endcapture %}
{% include quote.html text=sculpture_quote attribution="- Ursula Lehmann-Brockhaus, <em>The Final Years</em>" %}
...
<section data-gallery class="gallery-grid">
		...
		<figure>
			<a href="/assets/articles/atkins-jorn-final-years/sculpture_02.jpg"><img src="/assets/articles/atkins-jorn-final-years/sculpture_02.jpg"></a>
			<figcaption>L: Rigoletto, 1952/3, 28x18x12 cm. R: Man in the moon, 1953, 33x25 cm</figcaption>
		</figure>
</section>
...
{% endcapture %}
{% include quote.html text=jorn_quote attribution="- Asger Jorn, <em>Magi og skønne kunster</em>, 1971 (translated by Jytte Hardisty)" %}
...
<iframe src="https://archive.org/embed/jorn-final-years" width="100%" height="700" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>

*This is a preview only - <a href="https://archive.org/details/jorn-final-years" target="_blank">view fullsize on archive.org</a>*
