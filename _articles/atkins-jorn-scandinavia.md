...
**{{ page.title }}** {{page.description}} Documenting 855 oil paintings from the first twenty-three years of Jorn's career, it remains an essential reference work for the study of both Jorn and the modern Danish art movement as a whole.
...
{% endcapture %}
{% include quote.html text=jorn_quote attribution="- Asger Jorn, Preface to <em>Jorn in Scandinavia</em>" %}
