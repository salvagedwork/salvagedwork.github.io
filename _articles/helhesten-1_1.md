...
{% include infobox.html
    image="/assets/articles/helhesten/helhesten_1.1_cover.jpg"
    title="Helhesten (Year 1, Booklet 1)"
    editor="Robert Dahlmann Olsen"
    issue_date="April 13, 1941"
    cover_design="Henry Heerup"
    followed_by="Helhesten (Year 1, Booklet 2)"
%}
...
{% endcapture %}
{% include quote.html text=jacobsen_quote attribution="- Egill Jacobsen, &ldquo;Objectivity and Mystery,&rdquo; <em>Helhesten</em> 1, no. 1 (1941)" %}

## The Mission Statement

Inside the first issue, the group declared its mission:

{% capture mission_quote %}
...
{% endcapture %}
{% include quote.html text=mission_quote attribution="- <em>Helhesten</em> 1, no. 1 (1941)" %}
...
<iframe src="https://archive.org/embed/helhesten-1-1" width="100%" height="700" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>

*This is a preview only - <a href="https://archive.org/details/helhesten-1-1" target="_blank">view fullsize on archive.org</a>*
