...
{% include infobox.html
    ...
    issue_date="May 10, 1941"
    cover_design="Egon Mathiesen"
    followed_by="Helhesten (Year 1, Booklet 3)"
%}
...
{% endcapture %}
{% include quote.html text=jorn_quote attribution="- Asger Jorn, &ldquo;Intimate Banalities,&rdquo; <em>Helhesten</em> 1, no. 2 (1941)" %}
...
{% endcapture %}
{% include quote.html text=greaves_quote attribution="- Kerry Greaves, <em>War Horses</em> (2015)" %}
...
<iframe src="https://archive.org/embed/helhesten-1-2" width="100%" height="700" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>

*This is a preview only - <a href="https://archive.org/details/helhesten-1-2" target="_blank">view fullsize on archive.org</a>*
