...
{% endcapture %}
{% include quote.html text=preface_quote attribution="- Troels Andersen, Preface to the <em>Revised Supplement</em>" %}
...
{% endcapture %}
{% include quote.html text=conclusion_quote attribution="- Troels Andersen" %}
...
{% endcapture %}
{% include quote.html text=gauguin_quote attribution="- Pola Gauguin, <em>Dagbladet</em>, August 29, 1945" %}

An essay by Swedish artist Öyvind Fahlström provides critical assessment of Jorn's development:

{% capture fahlstrom_quote %}
...
{% endcapture %}
{% include quote.html text=fahlstrom_quote attribution="- Öyvind Fahlström" %}
...
{% endcapture %}
{% include quote.html text=michel_quote attribution="- Asger Jorn, interview with Jacques Michel, <em>Le Monde</em>, January 1971" %}
