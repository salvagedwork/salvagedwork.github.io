...
{% include infobox.html
    image="/assets/articles/helhesten/helhesten_2.56_cover.jpg"
    title="Helhesten (Year 2, Booklets 5 & 6)"
    editor="Robert Dahlmann Olsen"
    issue_date="November 11, 1944"
    cover_design="Carl-Henning Pedersen"
%}

**{{ page.title }}** {{page.description}}

This article is part of the [Helhesten](/collection/helhesten/) collection.
...
{% endcapture %}
{% include quote.html text=greaves_quote attribution="- Kerry Greaves, &ldquo;Hell-Horse: Radical Art and Resistance in Nazi-Occupied Denmark&rdquo;" %}
...
{% endcapture %}
{% include quote.html text=jorn_quote attribution="- Asger Jorn, &ldquo;The Prophetic Harps,&rdquo; <em>Helhesten</em> 2, nos. 5-6 (1944)" %}
...
{% include thumbnail.html
    image="/assets/articles/helhesten/helhesten_2.56_children.jpg"
    caption="Some of the print inserts in <cite>Helhesten</cite> were drawings made by children, as seen in this print from <cite>Helhesten</cite> year 2, booklets 5-6. The Helhesten artists believed in the ability of children's drawings to convey an uninhibited and uninfluenced sense of realism."
%}
...
{% endcapture %}
{% include quote.html text=atkins_quote attribution="- Guy Atkins, <em>Jorn in Scandinavia 1930-1953</em>" %}
